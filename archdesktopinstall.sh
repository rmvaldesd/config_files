...
#   find-file     busca un archivo en ~ y lo abre con su app por defecto, bind SUPER+CONTROL+SPACE
#   recent-files  recent files menu (apps, downloads, screenshots, modified) with
#                 per-file actions (open, copy path, folder, terminal, trash), bind SUPER+ALT+SPACE
