...
paquetes_utilidades=(
    ...
    glow              # Renderiza Markdown en la terminal (tablas alineadas, encabezados). Lo usa el atajo SUPER + / para mostrar docs/hyprland/README.md; sin él, ese atajo cae a 'less' y se ve el markdown crudo.
